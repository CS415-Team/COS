...
if(empty($cust_id) && empty($staff_id))
{
 ...
 if(isset($_POST["daterange"]) && isset($_POST["delivery_time"]) && isset($_POST["deliv"]))
 {
    ...
    $sql = "insert into mealsubscription (staff_id,subcription_date,start_date,end_date,delivery_time,delivery_location) 
    values ('$staff_id','$datentime','$startdate' ,'$enddate' , '$dlivery_time', '$location') ";
		...
		<div id="content-wrap" style="padding-bottom: 6rem;"><!-- all other page content -->
			<div class="middle" style="padding:60px; border:0px solid #0197A5; width:100%; margin-bottom:-140px;"><!--Main Div-->
				...
				<ul class="nav nav-tabs nabbar_inverse" id="myTab" style="margin-top:30; margin-bottom:-25px; background:#0197A5;border-radius:10px 10px 10px 10px;" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" style="color:#063344; font-weight:650;" id="viewitem-tab" data-toggle="tab" href="#viewitem" role="tab" aria-controls="viewitem" aria-selected="true" >Active Subscription</a>
					</li>
					<li class="nav-item">
                    <a class="nav-link" style="color:#063344; font-weight:650;" id="manageaccount-tab" data-toggle="tab" href="#manageaccount" role="tab" aria-controls="manageaccount" aria-selected="false">New Subscription</a>
					</li>
				</ul>
